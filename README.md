...
## Descripción
El objetivo de este proyecto es integrar la totalidad de los conceptos
estudiados durante el cuatrimestre para construir un Panel de Control de Clientes en
tiempo real.
